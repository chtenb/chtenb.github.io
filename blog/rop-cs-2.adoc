...
If we visualize the code flow above in a diagram, it becomes clear why this style of programming is sometimes referred to as https://fsharpforfunandprofit.com/rop/[_railway oriented programming_].
